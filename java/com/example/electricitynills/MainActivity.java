package com.example.electricitynills;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private TextView textViewResult, finalCostOutput,textTotalRebate;
    ...
    public void onClick(View v) {
        if (v == btnCalc) {
            try {
                ...
                // Set the output text
                textViewResult.setText(String.format("Total Charge: RM %.2f", totalCharges));
                textTotalRebate.setText(String.format("Total Rebate: RM RM %.2f" , totalRebate));
                finalCostOutput.setText(String.format("Final Cost: RM %.2f", total));
